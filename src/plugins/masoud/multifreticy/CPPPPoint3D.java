...
public class CPPPPoint3D {
	...
	public CPPPPoint3D(double xx, double yy, double zz) {
		this.x = xx;
		this.y = yy;
		this.z = zz;
	}

	public void setLocation(CPPPPoint3D other) {
		this.x = other.getX();
		this.y = other.getY();
		this.z = other.getZ();
	...
	public double distance(CPPPPoint3D second) {
	 ...
	 * @return
	 */
	public double distanceaniso(CPPPPoint3D second, double aniso) {
