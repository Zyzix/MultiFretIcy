...
public class CPSimilarityTransformation3D {
	...
	// Constructor
	public CPSimilarityTransformation3D(Matrix T, Matrix R, double[] scale,double orisizeX, double orisizeY, double orisizeZ) {
		this.dx = T.get(0, 0);
		this.dy = T.get(1, 0);
		this.dz = T.get(2, 0);
	...
	public CPSimilarityTransformation3D(Matrix Transfo, double orisizex2,
	...
	public void apply(CPPPPoint3D pnt) {
