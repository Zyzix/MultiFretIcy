...
public Workbook mergeExcelFiles(Workbook book, List<InputStream> inList) throws IOException, EncryptedDocumentException, InvalidFormatException {
...
public static void copySheets(Sheet newSheet, Sheet sheet, boolean copyStyle){     
    ...
    for (int i = sheet.getFirstRowNum(); i <= sheet.getLastRowNum(); i++) {
    	System.out.println("Copying row #" + i);
    ...
    for (int i = 0; i <= maxColumnNum; i++) {   
    	System.out.println("Copying columni #" + i);
