...
public class CPPointsPair {

	public Point2D first; // source
	public Point2D second; // target
	public String name;

	public CPPointsPair(Point2D first, Point2D second, String name) {
		this.first = first;
		this.second = second;
		this.name=name;
	}
	public CPPointsPair(Point2D first, Point2D second) {
		this.first = first;
		this.second = second;
		
	}
	
	public CPPointsPair(CPPointsPair other) {
